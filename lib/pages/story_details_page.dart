...
//Total Audio Duration
  ...
  Future <void> startAudio() async{
    ...
    await _audioPlayer.play(DeviceFileSource(widget.story.storyAudio),);
              ...
              children: [
                ...
                Expanded(
                  ...
                  onPressed: () async{
                    ...
                    final updatedStory = await Navigator.push(context,
                      MaterialPageRoute(
